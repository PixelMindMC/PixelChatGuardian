...
public class ConfigConstants {
    ...
    public static final String CHTAGUARD_RULES_BLOCK_OFFENSIVE_LANGUAGE = "chatguard-rules.blockOffensiveLanguage";
    public static final String CHTAGUARD_RULES_BLOCK_USERNAMES = "chatguard-rules.blockUsernames";
    public static final String CHTAGUARD_RULES_BLOCK_PASSWORDS = "chatguard-rules.blockPasswords";
    public static final String CHTAGUARD_RULES_BLOCK_HOME_ADDRESSES = "chatguard-rules.blockHomeAddresses";
    public static final String CHTAGUARD_RULES_BLOCK_EMAIL_ADDRESSES = "chatguard-rules.blockEmailAddresses";
    public static final String CHTAGUARD_RULES_BLOCK_WEBSITES = "chatguard-rules.blockWebsites";
